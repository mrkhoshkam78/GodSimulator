...
const PRAYER_TOPICS = [
  {topic:"سلامتی", text:"خدایا تنم را از بیماری برهان."},
  {topic:"عشق", text:"دلی بیابم که مرا بفهمد."},
  {topic:"خانواده", text:"خانواده‌ام را در پناه خود نگه دار."},
  {topic:"ثروت", text:"از تنگدستی رهایم کن تا نان سفره‌ام کم نیاید."},
  {topic:"موفقیت", text:"راهی برای موفقیت کارم بگشا."},
  {topic:"امنیت", text:"شب‌هایمان را از ترس خالی کن."},
  {topic:"بخشش", text:"خطاهایم را ببخش و دلم را سبک کن."},
  {topic:"امید", text:"اگر صدایم را می‌شنوی، امید را به دلم برگردان."},
  {topic:"دانش", text:"چشم عقلم را روشن کن."},
  {topic:"نجات دیگران", text:"کسی را که دوستش دارم از رنج برهان."}
];
